...
//         return res.status(200).send({ order });  // ✅ fixed: was { product: product }
//     } catch (error) {
//         return res.status(500).send({ message: error.message });
//     }
// };
...
//     confirmedorders,
// };
const { getallorder, confirmedorder, shiporder, deliverorder, cancelorder, removeorder } = require("../services/order.service");
